...
/*   Updated: 2022/10/23 19:04:40 by cyetta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout<<"ClapTrap constructor with name and default" << std::endl;
}

ClapTrap::ClapTrap(const std::string &name, int hp, int energy, int attack) :
	Name(name),  HitPoint(hp), Energy(energy), Attack(attack)
{
	std::cout<<"ClapTrap default constructor with all params" << std::endl;
}
